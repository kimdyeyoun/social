$(function () {
    ...
    if ($('#stat-line_9').length) {
        var lineChartCanvas = $("#stat-line_9").get(0).getContext("2d");
        var gradientStroke = lineChartCanvas.createLinearGradient(100, 60, 30, 0);
        gradientStroke.addColorStop(0, '#ff7fc7');
        gradientStroke.addColorStop(1, '#43b4ff');
        var lineChart = new Chart(lineChartCanvas, {
    ...
    if ($('#stat-line_10').length) {
        var lineChartCanvas = $("#stat-line_10").get(0).getContext("2d");
        var gradientStroke = lineChartCanvas.createLinearGradient(100, 60, 30, 0);
        gradientStroke.addColorStop(0, '#ff7fc7');
        gradientStroke.addColorStop(1, '#43b4ff');
        var lineChart = new Chart(lineChartCanvas, {
    ...
    if ($('#stat-line_11').length) {
        var lineChartCanvas = $("#stat-line_11").get(0).getContext("2d");
        var gradientStroke = lineChartCanvas.createLinearGradient(100, 60, 30, 0);
        gradientStroke.addColorStop(0, '#ff7fc7');
        gradientStroke.addColorStop(1, '#43b4ff');
        var lineChart = new Chart(lineChartCanvas, {
